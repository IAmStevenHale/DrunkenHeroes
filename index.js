...
const deck = {
  cards: [
    ...
    "Defeated!!\n\nYou're too drunk!\nYour arch nemesis beats you in battle!\n\nDrink.",
    "Defeated!!\n\nYou're too drunk!\nYour arch nemesis beats you in battle!\n\nDrink.",
    ...
    'No Paparazzi!\nWe are trying to have a good night!\n\nAny Hero who has snapped a pic tonight must take a drink for each photo that they have taken.',
    ...
    'PERMANENT SUPER POWER\n\nFinish a full drink to gain this power. If you decide to pass, the opportunity goes to the left.\n\nTwo-Face\nIf a card affects you, flip a coin. If you guess correctly ignore the affects, otherwise double the affects.',
    ...
    "I'm Batman\n\nAll Heroes must finish each sentence with 'I'm Batman' for the next full Round.\n\nEach time someone forgets, they must drink. ",
